...
const Tomandjerry = () => {
  ...
  const shuffleTiles = () => {
    ...
    for (let r = 0; r < rows; r++) {
      for (let c = 0; c < columns; c++) {
        const imgSrc = require(`./tomandjerry/${imgOrder.shift()}.png`);
        const tile = {
          id: `${r}-${c}`,
          src: imgSrc,
        };
  ...
  return (
    <div className='backback' style={{width:"100%", height:"100vh",display:"flex" ,alignItems:"center",justifyContent:"space-around",paddingTop:"50px" , }}>
      ...
      <img id="title" style={{width:"200px",height:"200px",borderRadius:"9px"}} src={require('./assets/tomandjerry.jpg')} alt="Logo" className="mb-4" />
      <center><h1 style={{fontSize:"29px",color:'whitesmoke'}}>Tom and Jerry</h1></center>
      </div>
